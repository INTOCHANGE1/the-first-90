...
export function HabitGridSetupClient({
  initial,
}: {
  initial: Shape;
}) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <p className="text-sm text-ash">{PHASE_1_HABIT_GRID_SETUP.hint}</p>
      ...
      <FormFooter
        ...
        flush={flush}
        nextHref="/journal/phase/1"
        canContinue={filled}
        continueLabel="Save & finish phase 1 setup"
      />
    </div>
  );
}
